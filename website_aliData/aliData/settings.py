...
SECRET_KEY = '!*w!wt24tbo07xwigs(2xv9lb-wkwew&%+roj4%+2($*a0g*w@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'aliexpData',  # 数据库名，先前创建的
        'USER': 'root',     # 用户名，可以自己创建用户
        'PASSWORD': 'root',  # 密码   linux 123zxc
        'HOST': '',  # mysql服务所在的主机ip
        'PORT': '3306',         # mysql服务端口
    }
}
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'aliData/../static/')
